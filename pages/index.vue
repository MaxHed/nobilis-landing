...
// add meta tags in french
useHead({
  title: 'Nobilis Coutellerie - Couteaux de Luxe Personnalisables et Artisanaux',
  meta: [
...
onMounted(() => {
  if (headerRef.value && sideMenuRef.value) {
    headerRef.value.sideMenuRef = sideMenuRef.value
  }
})
</script>

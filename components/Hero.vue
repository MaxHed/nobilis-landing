<template>
  <section class="hero-section relative h-screen flex items-center justify-center">
        ...
        <div class="relative z-10 text-center px-6">
            ...
            <p class="text-2xl md:text-3xl mb-12 font-light tracking-wide">L'Art de la Coutellerie de Luxe</p>
            <a href="#products" class="bg-gold text-black px-6 sm:px-10 py-3 sm:py-4 rounded-full text-base sm:text-lg font-semibold hover:bg-white transition duration-300 uppercase tracking-wider inline-block">Découvrir nos créations</a>
        </div>
